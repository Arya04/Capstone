...
public class ForumThreadActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_post:
                Intent postIntent = new Intent(this, CreateThreadPage.class);
                postIntent.putExtra("id",getIntent().getIntExtra("id",0));
    ...
    private void forumCategoryGrab(final int id){
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_FORUM_THREADS, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(!error) {
                        ...
                        adapter = new CustomAdapter(ForumThreadActivity.this,fD);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ForumThreadActivity.this, LoginActivity.class);
    ...
    private void setUpListViewListener(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("threadName",fD.get(position).getTitle());
