...
--
-- Host: localhost:3306
-- Generation Time: Dec 02, 2016 at 05:37 AM
...
(5, '580676c03781c9.84598202', 'Nick Kirschke', 'Captian of the men\'s lacrosse team', 'Senior', 'nick@cnu.edu', 'rS2yNSfKLxic6OlAE/RIT9dOkB4xMzY1MmVjNjI3', '13652ec627', '2016-10-18 15:23:44', ''),
...
(15, '583f813cd83bb4.84509255', 'MickeyBlueShoes', '', '', 'allie.mcwilliams.13@cnu.edu', 'OE/8UjQ+DAYLa4K9u8Ej4WLSXgQ5ZWY0MWQxMDAy', '9ef41d1002', '2016-11-30 20:47:40', NULL);
...
ALTER TABLE `forumThread`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idThreadCategory` (`idCategory`);
...
--
ALTER TABLE `forumThread`
  ADD CONSTRAINT `forumthread_ibfk_1` FOREIGN KEY (`idCategory`) REFERENCES `forumCategory` (`id`);
